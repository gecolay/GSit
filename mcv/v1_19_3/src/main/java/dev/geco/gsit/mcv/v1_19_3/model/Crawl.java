...
import dev.geco.gsit.mcv.v1_19_3.entity.BoxEntity;
            ...
            for(int x = 0; x < size; x++) {
                for(int z = 0; z < size; z++) {
                    ...
                    if(!boxEntitiesExist) {
                        ...
                        serverPlayer.connection.send(new ClientboundSetEntityDataPacket(entity.getId(), entity.getEntityData().getNonDefaultValues()));
                    } else {
                        serverPlayer.connection.send(new ClientboundSetEntityDataPacket(entity.getId(), entity.getEntityData().getNonDefaultValues()));
