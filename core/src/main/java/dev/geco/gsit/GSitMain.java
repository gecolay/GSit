...
import dev.geco.gsit.cmd.GLegsUpCommand;
...
public class GSitMain extends JavaPlugin {
    ...
    private void setupCommands() {
        ...
        getCommand("glegsup").setExecutor(new GLegsUpCommand(this));
        getCommand("glegsup").setTabCompleter(new EmptyTabComplete());
        getCommand("glegsup").setPermissionMessage(messageService.getMessage("Messages.command-permission-error"));
