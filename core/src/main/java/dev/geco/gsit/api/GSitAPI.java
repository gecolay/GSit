...
public class GSitAPI {
    ...
    */
     ...
     * @param YOffset The Y-Coordinate-Offset for the Seat (Default: Block-BoundingBox-MinY + Block-BoundingBox-Height - Block-Y)
     ...
     * @param YOffset The Y-Coordinate-Offset for the PoseSeat (Default: Block-BoundingBox-MinY + Block-BoundingBox-Height - Block-Y)
