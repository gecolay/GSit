...
public class PlotSquaredLink {
    ...
    public boolean canCreateSeat(Location Location, Player Player) { return canCreate(Location, Player); }

    public boolean canCreatePlayerSeat(Location Location, Player Player) { return canCreate(Location, Player); }
